...
public class EntityAISusanoo extends EntityAIBase {
    private final EntitySusanooBase tameable;
    ...
    public EntityAISusanoo(EntitySusanooBase tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
    ...
    public void updateTask() {
        ...
        if (--this.timeToRecalcPath <= 0) {
            ...
            if (!this.petPathfinder.tryMoveToEntityLiving(this.owner, this.followSpeed) && !this.tameable.getLeashed() && !this.tameable.isRiding() && this.tameable.getDistanceSq(this.owner) >= (double)144.0F) {
