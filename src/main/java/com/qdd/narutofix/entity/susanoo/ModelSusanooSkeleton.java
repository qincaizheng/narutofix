...
/**
 * Model for the Susanoo Skeleton (first form).
 * Copied from {@link net.narutomod.entity.EntitySusanooSkeleton.Renderer.ModelSusanooSkeleton}
...
public class ModelSusanooSkeleton extends ModelBiped {
    ...
    boolean renderFlame;
    private final float[][] rightArmPreset = {
        { -1.0472F, 1.0472F, 0.5236F },
        { -1.0472F, -1.0472F, 0.0F },
        { -0.9599F, 0.0F, 0.0F }
    };
    ...
    public ModelSusanooSkeleton() {
        ...
        setRotationAngle(leftFingers, 0.0F, 0.0F, -1.0472F);
    ...
    public void render(Entity entity, float f, float f1, float age, float f3, float f4, float f5) {
        ...
        int color = ((SusanooSkeletonEntity) entity).getFlameColor();
